//source code for the DLL. Taken from https://superuser.com/a/1436051/490393
...
extern "C" {          // we need to export the C interface
	...
	__declspec(dllexport) int __cdecl scan()
	{
		unsigned int result;
...
#undef X
			...
			if (result == ERROR_SUCCESS)
			{
				...
				result = WlanCloseHandle ? WlanCloseHandle(handle, NULL) : ERROR_PROC_NOT_FOUND;
			}
		}
